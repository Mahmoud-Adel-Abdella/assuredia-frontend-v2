...
const Icon = {
  ...
  flows: (p: IconProps) => (
    ...
    >
      ...
      <path
        strokeLinecap="round"
        d="M6 8.5v3a3 3 0 003 3h.5M18 8.5v3a3 3 0 01-3 3h-.5"
      />
    </svg>
  ),
    ...
    <div className="flex h-full flex-col bg-surface">
      ...
      <div
        className={cx(
          ...
          collapsed ? "justify-center gap-0.5 px-0.5" : "px-4",
        )}
      >
        {collapsed ? (
        ...
        {onToggleCollapsed && (
          <div className="group relative shrink-0">
            ...
            >
              ...
              <span
                className={cx(
                  "absolute -top-1 size-2 rotate-45 bg-slate-900",
                  collapsed ? "start-3" : "end-3",
                )}
              />
            </div>
          </div>
      ...
      <div
        className={cx("border-t border-slate-100", collapsed ? "p-2" : "p-3")}
      >
        ...
        {onAdmin &&
          (collapsed ? (
            ...
            >
              <span className="flex size-5 items-center justify-center rounded-sm bg-warning text-[9px] font-bold text-white">
                A
              </span>
            </button>
          ) : (
            ...
            >
              <span className="flex size-4 items-center justify-center rounded-sm bg-warning text-[8px] font-bold text-white">
                A
              </span>
              {t("nav.adminConsole")}
              <svg
                className="ms-auto size-3.5 text-amber-400 rtl:-scale-x-100"
                viewBox="0 0 20 20"
                fill="currentColor"
              >
                <path
