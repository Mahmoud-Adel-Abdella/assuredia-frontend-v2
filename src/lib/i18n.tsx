...
const dict: Record<string, Entry> = {
  ...
  "evidence.hide": { en: "Hide Evidence", ar: "إخفاء الدليل" },
  ...
  "evidence.elements.role": { en: "Role", ar: "الدور" },
  "evidence.elements.name": { en: "Name", ar: "الاسم" },
  ...
  "evidence.elements.strength": { en: "Strength", ar: "القوة" },
  ...
  "evidence.network.method": { en: "Method", ar: "الطريقة" },
  "evidence.network.url": { en: "URL", ar: "الرابط" },
  "evidence.network.status": { en: "Status", ar: "الحالة" },
  ...
  "evidence.duration.unknown": { en: "—", ar: "—" },
